  ...
  useEffect(() => {
    const timer = window.setTimeout(async () => {
      ...
      try {
        ...
        setQuote(data.quote ?? undefined); setBalance(data.balance);
